// Hierarchical data extracted from wctquestionscombined.xlsx
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            subtopics: [{ name: 'Foreign Exchange Reserves' }, { name: 'Foreign Exchange Rates' }],
          },
          {
            name: 'Exchange rate',
            subtopics: [{ name: 'Foreign Exchange Rates' }],
          },
        ],
      },
      {
        ...
        topics: [
          {
            ...
            subtopics: [{ name: 'IMF' }, { name: 'World Bank' }, { name: 'Washington Consensus' }],
          },
          {
    ...
    modules: [
      {
        ...
        topics: [
          {
            name: 'Indian Location \nSetting and physiographic regions',
            subtopics: [
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            subtopics: [{ name: 'Railways' }, { name: 'Waterways' }],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            subtopics: [{ name: 'Agriculture Density' }, { name: 'Rice Cultivation' }],
          },
          {
            name: 'Mapping',
            subtopics: [
    ...
    modules: [
      ...
      },
      {
        ...
        topics: [
          ...
          {
            name: 'Fundamental Rights-',
            subtopics: [{ name: 'Definition of State' }],
          },
          {
      ...
      },
      {
        ...
        topics: [
          ...
          {
            name: 'Citizenship',
            subtopics: [{ name: 'Termination of Citizenship' }],
          },
        ],
      },
      {
    ...
    modules: [
      {
        ...
        topics: [
          ...
          {
            name: 'Miscellaneous',
            subtopics: [{ name: 'Critical Minerals' }],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          {
            name: 'Defence',
            subtopics: [{ name: 'Missiles' }, { name: 'Missile Technology Control Regime' }],
          },
        ],
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            subtopics: [{ name: 'Flu Gas Desulphurization' }],
          },
        ],
      },
      {
        ...
        topics: [
          ...
          {
            name: 'Cell Biology',
            subtopics: [{ name: 'Stem Cells' }],
          },
          {
            name: 'Gravitation',
            subtopics: [{ name: 'Langarage Points' }],
          },
          {
            name: 'States of Matter',
            subtopics: [{ name: 'Plasma State' }],
          },
          {
            name: 'Biology',
            subtopics: [{ name: 'Cell Biology' }],
          },
          {
          ...
          },
          {
            ...
            subtopics: [{ name: 'Prokaryotic Organisms' }, { name: 'Bacteria' }],
          },
          {
            name: 'Biomolecules',
            subtopics: [
          ...
          {
            name: 'Chemistry',
            subtopics: [{ name: 'Organocatalyst' }, { name: 'Specific Heat Of Substance' }],
          },
          {
            name: 'Light and its Properties',
            subtopics: [{ name: 'Concave Mirrors' }, { name: 'Refraction of Light' }],
          },
          {
            name: 'Wave Motion',
            subtopics: [{ name: 'Sound Waves' }, { name: 'Surface Waves' }],
          },
          {
            name: 'Electromagnetic Waves',
            subtopics: [{ name: 'Electromagnetic Spectrum' }],
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            subtopics: [{ name: 'Montreal Protocol' }],
          },
          {
            name: 'Environment Impact Assessment',
            subtopics: [{ name: 'EIA Features' }],
          },
          {
            name: 'Climate Change',
            subtopics: [
...
export function getModules(subject?: string): string[] {
  ...
  const subjectData = hierarchicalData.find(s => s.name.toLowerCase() === subject.toLowerCase());
...
export async function getQuestions(
  ...
  try {
    const response = await fetch(
      `/api/questions?subject=${subject}&module=${module}&topic=${topic}&sub_topic=${subtopic}`
    );
