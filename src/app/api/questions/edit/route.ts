...
function processField(field: string, value: any): any {
    ...
    switch (field) {
        ...
        case 'Question_Type':
        case 'Question Type': {
            const validQuestionTypes = ['Objective', 'Subjective', 'MCQ', 'True/False', 'Fill in the Blank'];
        ...
        case 'Nature of Question': {
            ...
            const capitalizedNature = stringValue.charAt(0).toUpperCase() + stringValue.slice(1).toLowerCase();
...
export async function PUT(request: NextRequest) {
    try {
        ...
        console.log('2. FULL Question Object (ALL KEYS):', 
        ...
        console.log('2b. Question Object Key Types:', 
            Object.keys(question).reduce((acc, key) => {
        ...
        console.log('6b. Original Question:', 
        ...
        const finalQuestion = processedQuestion.Question?.trim().length >= 5 
        ...
        const result = stmt.run(
            ...
            processedQuestion['Question_Type'] || processedQuestion['Question Type'] || originalQuestion['Question_Type'] || null,
            ...
            processedQuestion['Faculty Approved'] !== undefined 
                ? (processedQuestion['Faculty Approved'] ? 1 : 0) 
                : (originalQuestion['Faculty Approved'] ? 1 : 0),
