...
export default function TestManagement() {
  ...
  return (
    <Box>
        ...
        <TableContainer>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell>
                  {activeTab === 'exported' ? 'Test Name' : 'Draft Name'}
                </TableCell>
                <TableCell>Batch</TableCell>
                <TableCell>
                  {activeTab === 'exported' ? 'Created Date' : 'Draft Date'}
                </TableCell>
                <TableCell>
                  {activeTab === 'exported' ? 'Question Count' : 'Questions'}
                </TableCell>
              ...
              {activeTab === 'exported' ? (
                ...
                (rowsPerPage > 0
                  ...
                  <TableRow key={draftCart.id}>
                    ...
                    <TableCell>
                      {new Date(draftCart.created_at).toLocaleDateString()}
                    </TableCell>
      ...
      >
        <DialogTitle>
          Draft Cart Details: {selectedDraftCart?.test_name}
        </DialogTitle>
        <DialogContent>
          {selectedDraftCart && (
            <Box>
              ...
              <Typography variant="body1">
                <strong>Draft Date:</strong> {new Date(selectedDraftCart.created_at).toLocaleString()}
              </Typography>
              <Typography variant="body1">
        ...
        <DialogActions>
          <Button 
            onClick={() => setSelectedDraftCart(null)} 
            color="secondary"
          >
            Close
          </Button>
