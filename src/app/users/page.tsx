    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            try {
                ...
                throw new Error(`Network error: ${networkError instanceof Error ? networkError.message : 'Unable to connect'}`);
            }
            ...
            if (validUsers.length === 0) {
                ...
                throw new Error(
                    data.message || 
                    'No valid users found. Please contact your administrator.'
                );
            }
